...
class ImpulseForce : public ParticleForce {
    ...
    ofVec3f normal;
public:
    void set(ofVec3f &vel, ofVec3f &norm) {velocity = vel; normal = norm; }
    ImpulseForce(const ofVec3f &vel, const ofVec3f &norm);
    void updateForce(Particle *);
};
...
public:
    void set(const ofVec3f a) { acceleration = a; }
    ThrusterForce(ofVec3f a);
    void updateForce (Particle *);
